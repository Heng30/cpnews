...
#define PRODUCT_NAME           "cpnews" // 产品名称
...
#define INTERNAL_NAME          "cpnews.exe"
#define FILE_DESCRIPTION       "cpnews can display crypto news"  // 文件说明
#define LEGAL_COPYRIGHT        "Copyright 2023-2033 The Heng30 Company Ltd. All rights reserved." // 版权
#define ORIGINAL_FILE_NAME     "cpnews.exe"    // 原始文件名
